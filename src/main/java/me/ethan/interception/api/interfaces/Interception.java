...
import me.ethan.interception.api.InjectedStroke;
...
public interface Interception extends Library {
	...
	int interception_receive(Pointer context, int device, InjectedStroke stroke, int nstroke);
	...
	// nstroke);
	int interception_send(Pointer context, int device, InjectedStroke stroke, int nstroke);
